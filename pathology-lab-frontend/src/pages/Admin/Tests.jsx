...
export default function Tests() {
    ...
    const [tests, setTests] = useState([
        { id: 1, name: "CBC (Complete Blood Count)", price: 300, tube: "EDTA Tube (Purple)" },
        { id: 2, name: "Blood Sugar (Fasting)", price: 150, tube: "Fluoride Tube (Grey)" },
        { id: 3, name: "LFT (Liver Function Test)", price: 450, tube: "Plain Tube (Red)" },
    ]);
            ...
            {editingTest && (
                <Modal title="Edit Test" onClose={() => setEditingTest(null)}>
                    <AddTestForm
                        ...
                        onAddTest={(updated) => handleEdit(updated)}
                        existingTest={editingTest} // ✅ pre-fills current details
                    />
                </Modal>
            )}
        </div>
